...
class DemandeRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'is_bachelier.required'=> 'Votre statut est obligatoire',
            'point_bac.required_if'=> 'Votre point est obligatoire',
            'mention_bac.required_if'=> 'Votre mention est obligatoire',
    ...
    {
        return [
            'num_carte'=> 'required|unique:demandes',
            'nom_etudiant'=> 'required',
            'prenoms_etudiant'=> 'required',
            'date_naissance_etudiant'=> 'required',
            'lieu_naissance_etudiant'=> 'required',
            'contact_etudiant'=> 'required|unique:demandes',
            'email_etudiant'=> 'required|unique:demandes',
