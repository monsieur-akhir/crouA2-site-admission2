            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form  class="pt-3" id="inscription_form" method="POST">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Vous avez un compte? <a href="<?php echo e(route('login')); ?>" class="text-primary">Connectez-vous</a>
                </div>
              </form>
            </div>
          </div>
  ...
  <script>
    ...
    $('#inscription_form').submit(function(event) {
      ...
      if (password == '' || password === undefined) {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo e(url('creer-compte')); ?>",
          data: {
            password: password,
            email: email,
            nom: nom,
...
</html><?php /**PATH /home/admin/web/vps-8a0d3bf3.vps.ovh.net/public_html/resources/views/layouts/sinscrire.blade.php ENDPATH**/ ?>