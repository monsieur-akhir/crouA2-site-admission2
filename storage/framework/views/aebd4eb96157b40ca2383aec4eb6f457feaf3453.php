                    ...
                    <tbody>
                      <?php $__currentLoopData = $demandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $demande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                  ...
                                  <td>
                                        <a href="<?php echo e(url('details-demandes-readmission?mat='.$demande->matricule_crou)); ?>"  class="btn btn-success p-2">
                                         TRAITER 
                                        </a>
                                  </td>
                                </tr>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/admission.croua2.ci/public_html/resources/views/layouts/traiter-readmission.blade.php ENDPATH**/ ?>