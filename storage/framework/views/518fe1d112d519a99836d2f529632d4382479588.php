        ...
        <div class="card">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <h4> NOMBRE DE DOSSIERS DEPOSES PAR UNIVERSITE</h4>
              ...
              <br>
              <h4>NOMBRE DE DOSSIERS DEPOSES PAR UFR (UNIVERSITE NANGUI ABROGOUA)</h4>
              <div class="table-responsive pt-3">
              <table  class="table table-bordered">
                <thead>
                  <tr>
              ...
              <br>
              <h4> NOMBRE DE DOSSIERS DEPOSES PAR UNIVERSITE (MASCULIN)</h4>
              <div class="table-responsive pt-3">
              <table  class="table table-bordered">
                <thead>
                  <tr>
              ...
              <br>
              <h4> NOMBRE DE DOSSIERS DEPOSES PAR UNIVERSITE (FEMININ)</h4>
              <div class="table-responsive pt-3">
              <table  class="table table-bordered">
                <thead>
                  <tr>
              ...
              <br>
              <h4>NOMBRE DE DOSSIERS DEPOSES PAR NIVEAU ACTUEL</h4>
              <div class="table-responsive pt-3">
              <table  class="table table-bordered">
                <thead>
                  <tr>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/vps-8a0d3bf3.vps.ovh.net/public_html/resources/views/layouts/rapports_depose.blade.php ENDPATH**/ ?>