            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="/traiter" method="POST">
                    ...
                    <?php elseif($demande->statut == 3): ?>
                        <button type="submit" name="statut" value="-1" class="btn btn-danger">Retirer l'attribution la demande</button>
                    <?php else: ?>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/admission.croua2.ci/public_html/resources/views/layouts/details-demande.blade.php ENDPATH**/ ?>