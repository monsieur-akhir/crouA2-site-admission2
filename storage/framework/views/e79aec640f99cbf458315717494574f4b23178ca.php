...
<body>
    ...
    <section style="margin-top:230px;">
        ...
        <div style="float: left;width:50%">
            ...
            <?php if($data->handicap_etudiant == "Oui"): ?><p>PRECISION DE L'HANDICAP :§: n <span style="font-weight:bold"><?php echo e(strtoupper($data->precision_handicap)); ?></span></p> <?php endif; ?>
...
</html><?php /**PATH /var/www/admission.croua2.ci/public_html/resources/views/dossiers/fiche.blade.php ENDPATH**/ ?>