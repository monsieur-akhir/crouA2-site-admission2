          ...
          <div class="icon-boxes d-flex flex-column justify-content-center col-md-12">
            ...
            <div class="row">
              ...
              <section class="get-in-touch">
                ...
                <form class="contact-form row form-group" method="POST" action="<?php echo e(url('consultation')); ?>" id="resultat_form" >
                  <?php echo csrf_field(); ?>
                  <div id="response"></div>
                  <div class="form-field col-lg-6">
                    <input value="<?php echo e(old('matricule_crou')); ?>" type="text" id="matricule_crou" name="matricule_crou"  class="input-text js-input" type="text" required>
...
</html><?php /**PATH /var/www/admission.croua2.ci/public_html/resources/views/layouts/consulter-resultat.blade.php ENDPATH**/ ?>