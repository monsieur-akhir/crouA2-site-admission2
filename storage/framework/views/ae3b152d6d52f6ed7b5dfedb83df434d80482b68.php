              ...
              <div class="card-body">
                <form action="/traiter-readmission" method="POST">
                    ...
                    <div style="float:right">
                      <a href="trouver-fiche-readmission?matricule_crou=<?php echo e($demande->matricule_crou); ?>&date_naissance_etudiant=<?php echo e($demande->date_naissance_etudiant); ?>" name="statut" value="1" class="btn btn-primary">Modifier</a>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/admission.croua2.ci/public_html/resources/views/layouts/details-demande-readmission.blade.php ENDPATH**/ ?>