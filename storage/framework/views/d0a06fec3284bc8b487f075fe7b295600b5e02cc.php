...
<script>
  $('#add_bat_form').submit(function(event) {
    ...
    if (libelle == '' || libelle === undefined) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo e(route('add-batiment')); ?>",
        data: {
          cite_id: cite_id,
          libelle: libelle,
          _token: _token
  ...
  function updateBatiment(id) {
    ...
    if (libelle == '' || libelle === undefined) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo e(route('update-batiment')); ?>",
        data: {
          id: batiment_id,
          libelle: libelle,
          cite_id: cite_id,
                      ...
                      <div class="row">
                        <div class="form-group col-md-12">
                          ...
                          <select class="form-control select2" style="width: 100%" name="cite_id" id="cite_id" required>
                            ...
                            <option value="<?php echo e($cite->id); ?>">
                              <?php echo e($cite->libelle); ?> 
                            </option>
              ...
              <div class="table-responsive pt-3">
                <table id="dataTable" class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo e($batiment->libelle); ?></td>
                      <td><?php echo e($batiment->cite->libelle); ?></td>
                      <td>
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal<?php echo e($batiment->id); ?>">
                          Modifier
                        </button>
                      </td>
                      <!-- Modal -->
                      <div id="myModal<?php echo e($batiment->id); ?>" class="modal fade" role="dialog">
                            ...
                            <div class="modal-body">
                              <form>
                                ...
                                <div class="row">
                                  <div class="form-group col-md-12">
                                    <label>Cité</label>
                                    <select class="form-control" name="cite_id<?php echo e($batiment->id); ?>" id="cite_id<?php echo e($batiment->id); ?>" required>
                                      <?php $__currentLoopData = $cites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($cite->id); ?>" <?php if($batiment->cite_id == $cite->id ): ?> <?php echo e('selected=selected'); ?> <?php endif; ?>>
                                        <?php echo e($cite->libelle); ?> 
                                      </option>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                  ...
                                  <div class="form-group col-md-12">
                                    <label>Libelle bâtiment</label>
                                    <input required type="text" value="<?php echo e($batiment->libelle); ?>" class="form-control" name="libelle<?php echo e($batiment->id); ?>" id="libelle<?php echo e($batiment->id); ?>">
                                  </div>
                                </div>
                                <div class="modal-footer" style="background-color: white">

                                  <button onclick="updateBatiment('<?php echo e($batiment->id); ?>')" class="btn btn-primary">Enregistrer</button>
                                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                </div>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/admission.croua2.ci/public_html/resources/views/layouts/batiment.blade.php ENDPATH**/ ?>