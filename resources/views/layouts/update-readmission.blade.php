                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <select required name="cite_id" class="form-control select2" id="cite">
                      ...
                      <option {{$demande->cite_id == $cite->id?"selected":null}} value="{{$cite->id}}">{{$cite->libelle}}</option>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <select required name="batiment_id" class="form-control select2"  id="batiment">
                      ...
                      <option {{$demande->batiment_id == $batiment->id?"selected":null}} value="{{$batiment->id}}">{{$batiment->libelle}}</option>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <select required name="palier_id" class="form-control select2"  id="palier">
                      ...
                      <option {{$demande->palier_id == $palier->id?"selected":null}} value="{{$palier->id}}">{{$palier->libelle}}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="form-group col-md-6">
                    ...
                    <select required name="chambre_id" class="form-control select2"  id="chambre">
                      ...
                      <option {{$demande->chambre_id == $chambre->id?"selected":null}} value="{{$chambre->id}}">{{$chambre->libelle}}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="form-group col-md-6">
                    ...
                    <select required name="lit_id" class="form-control select2"  id="lit">
                      @foreach ($lits ?? [] as $lit)
                      <option {{$demande->lit_id == $lit->id?"selected":null}} value="{{$lit->id}}">{{$lit->libelle}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
