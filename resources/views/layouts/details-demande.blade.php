              ...
              <div class="card-body">
                <form action="/traiter" method="POST">
                    ...
                    <div style="float:right">
                      <a href="trouver-fiche?matricule_crou={{$demande->matricule_crou}}&date_naissance_etudiant={{$demande->date_naissance_etudiant}}" name="statut" value="1" class="btn btn-primary">Modifier</a>
