            ...
            @if ($demande)
                        ...
                        <div class="row no-gutters">
                            <div class="content col-xl-5 col-md-5 col-lg-5 d-flex align-items-stretch"
                                ...
                                <div class="content content text-center center">
                                    ...
                                    <h2 CLASS="text-center">Monsieur/Madame <b>{{$demande->nom_etudiant}}</b>
                                        <b>{{$demande->prenoms_etudiant}} </b> vous êtes admis(e) en
               ...
               <h3 class="text-align-center">
                                        <p style="font-size: 25px"> Nom et Prénom(s): <b>{{$demande->nom_etudiant}}</b>
                                            <b>{{$demande->prenoms_etudiant}} </b><br> <br></p>
               <p> Identifiant CROU Abidjan 2: <b>{{$demande->matricule_crou}}</b> <br> <br></p>
               <p> N° Carte Etudiant(CE): <b>{{$demande->num_carte}}</b>  <br><br></p>
                <p>Date de naissance: <b>{{$demande->date_naissance_etudiant}}</b> <br>  </p></h3>
                                                  </span>
                                            <div class="row">
                        ...
                        <div class="content col-xl-5 col-md-5 col-lg-5 d-flex align-items-stretch"
                            ...
                            <div class="content text-center center">
                                ...
                                <h3 class=" text-center font-weight-bold"> Monsieur/Madame
                                    ...
                                    <b>{{$demande->prenoms_etudiant}}, vous n'êtes pas admis en Résidence Universitaire.</b> <br>
                                </h3>
