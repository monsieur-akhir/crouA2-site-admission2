            ...
            <div class="row">
                <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1">
                    <div>
                        ...
                        <a href="{{url('demande')}}" class="download-btn" data-bs-toggle="modal"
                                    ...
                                    <div class="modal-body d-flex">
                                        <div class="d-flex justify-content-around">
                                            <div class="p-2 order-1">
                                                <button type="button" class="btn btn-secondary btn-md" ><a href="{{url('demande')}}" class="text-white"><i
                                            ...
                                            <div class="p-2 order-2">
                                                ...
                                                <a href="{{url('reattribution-chambre')}}" class="text-white"><i class='bx bxs-file-doc'></i>
                                                    Readmission</a>
                                                </button>
                                            </div>
                                        </div>
