    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="tel:+2250173939332" style="color: #fd7e14; font-size: large">+225 01 73 93 93 32 <i class="bi bi-telephone" ></i></a>
...
<section id="hero" class="d-flex align-items-center">
    ...
    <div class="container d-flex flex-column align-items-center justify-content-center" data-aos="fade-up">
        ...
        <a href="#about" class="btn-get-started scrollto" style="background: #fd7e14;">Mon résultat</a>
        <img src="assets2/img/fleche-vers-le-bas.gif" style="width: 100px; height: 100px" class="img-fluid fleche hero-img " alt="" data-aos="zoom-in" data-aos-delay="150">
    </div>
